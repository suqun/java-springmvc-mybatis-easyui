		...
		<form id="form" method="post">
			<table class="table table-hover table-condensed">
				<tr>
					...
					<th>所属角色</th>
					<td><select id="roleIds" name="roleIds" style="width: 140px; height: 29px;"></select><img src="<%=request.getContextPath()%>/style/images/extjs_icons/cut_red.png" onclick="$('#roleIds').combotree('clear');" /></td>
				</tr>
			</table>
		</form>
	</div>
