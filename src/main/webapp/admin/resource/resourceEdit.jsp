		...
		<form id="form" method="post">
			<table class="table table-hover table-condensed">
				...
				<tr>
					...
					<th>资源类型</th>
					<td><select name="resourcetypeId" class="easyui-combobox" data-options="width:140,height:29,editable:false,panelHeight:'auto'">
				...
				<tr>
					<th>备注</th>
					<td colspan="3"><textarea name="description" rows="" cols="" class="span5">${resource.remark}</textarea></td>
				</tr>
			</table>
		</form>
	</div>
